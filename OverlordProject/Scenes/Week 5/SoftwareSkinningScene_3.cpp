...
void SoftwareSkinningScene_3::Update()
{
	...
	for (int i{}; i < m_SkinnedVertices.size(); ++i)
	{
		...
		{
			const auto transformedVertexBone0 = XMVector3TransformCoord(XMLoadFloat3(&skinnedVertex.originalVertex.Position), bone0Transform);
			const auto transformedVertexBone1 = XMVector3TransformCoord(XMLoadFloat3(&skinnedVertex.originalVertex.Position), bone1Transform);
...
void SoftwareSkinningScene_3::PostInitialize()
{
}
